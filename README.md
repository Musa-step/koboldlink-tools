...
For processing primary chat requests and function-calling requests from KoboldLink, you can select different LLMs in TextAudioToolPref.json file that best suit these two different tasks (parameters "Horde  model (chat)" and "Horde  model (function call)", correspondingly).

Use with KoboldLink v22 or higher.
